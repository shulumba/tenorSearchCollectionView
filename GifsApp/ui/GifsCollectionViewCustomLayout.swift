//
//  GifsCollectionViewCustomLayout.swift
//  GifsApp
//
...
class GifsCollectionViewCustomLayout: UICollectionViewLayout {
    //1. Pinterest Layout Delegate
    weak var delegate: GifsCollectionViewCustomLayoutDelegate!
